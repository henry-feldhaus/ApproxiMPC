    ...
    def __init__(
        ...
        if self.show_wheels:
            ...
            fl_vertices = _get_tire_vertices(
                self.pose, self.car_length, self.car_width, self.tire_width, self.tire_length, "fl", self.steering
            )
            ...
            fr_vertices = _get_tire_vertices(
                self.pose, self.car_length, self.car_width, self.tire_width, self.tire_length, "fr", self.steering
            )
